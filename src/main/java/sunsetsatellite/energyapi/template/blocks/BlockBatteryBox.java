...
public class BlockBatteryBox extends BlockTileEntityRotatable {
    public BlockBatteryBox(String key, int i, Material material) {
    ...
    public boolean blockActivated(World world, int i, int j, int k, EntityPlayer entityplayer)
    {
        if(Minecraft.getMinecraft(Minecraft.class) != null)
        {
            ...
            if(tile != null) {
                ((IEntityPlayer)entityplayer).displayGuiScreen_energyapi(new GuiBatteryBox(entityplayer.inventory, tile),new ContainerBatteryBox(entityplayer.inventory,tile),tile);
            }
        }
        return true;
    }
